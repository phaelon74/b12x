...
The output file feeds ``b12x.integration.tp_moe.b12x_moe_fp6`` directly (load with
``b12x.quantization.load_fp6_moe_weights``). Activations are NOT quantized here:
