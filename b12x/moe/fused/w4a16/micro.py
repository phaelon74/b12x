"""Packed-form W4A16 direct micro MoE kernel for SM120."""
...
class MoEMicroKernelBackend:
    """Decode-focused compact W4A16 MoE kernel for SM120.

    This fork is intentionally separate from ``b12x.moe.fused.micro`` so
    packed-form W4A16 addressing can evolve without changing the W4A4/NVFP4
    direct micro path.
    """
