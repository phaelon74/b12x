...
def test_mla_kv_stage_fits_bf16_debug_qk():
    """BF16 QK debug staging uses 2x vec stride; undersized smem corrupts adjacent fields."""
    from b12x.attention.mla.kernel import (
        _MLA_KV_NOPE_QK_STAGE_BYTES,
        _MLA_KV_STAGE_BYTES,
    )

    assert _MLA_KV_STAGE_BYTES >= _MLA_KV_NOPE_QK_STAGE_BYTES
