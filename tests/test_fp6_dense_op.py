...
def _make_weight(n: int = 256, k: int = 256):
    from b12x.quantization.fp6_dense_weights import quantize_dense_weight_to_fp6
...
def test_custom_op_matches_eager():
    ...
    from b12x.quantization.fp6_dense_weights import dense_fp6_linear
...
def test_bytes_quantizer_matches_packed_expand():
    ...
    from b12x.quantization.fp6_dense_weights import (
