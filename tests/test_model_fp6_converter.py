...
def test_load_fp6_moe_checkpoint_cpu(tmp_path) -> None:
    ...
    from b12x.quantization.fp6_safetensors_load import load_fp6_moe_checkpoint
...
def test_load_fp6_dense_checkpoint_cpu(tmp_path) -> None:
    ...
    from b12x.quantization.fp6_safetensors_load import load_fp6_dense_checkpoint
