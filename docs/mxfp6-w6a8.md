...
| Model | KLD | Position |
|-------|-----|----------|
| Qwen3.6-27B dense (W6A8) | 0.033389 | measured W6A8 dense floor: weight slice ~0.023 + activation slice ~0.011 |
| Qwen3.6-35B-A3B MoE (W6A8) | 0.015043 | FP8 band (FP8 ~0.0158) |
